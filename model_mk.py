...
def model_maker_LSTM(x_train, y_train, x_val, y_val, conf):
	model = Sequential()
	m_perf = {}
	if conf["layer2"] == 0:
...
def model_maker_GRU(x_train, y_train, x_val, y_val, conf):
	model = Sequential()
	m_perf = {}
	if conf["layer2"] == 0:
...
def model_maker_SimpleRNN(x_train, y_train, x_val, y_val, conf):
	model = Sequential()
	m_perf = {}
	if conf["layer2"] == 0:
...
def model_maker_MPL(x_train, y_train, x_val, y_val, conf):
	model = Sequential()
	if conf["layer2"] == 0:
...
def model_maker(x_train, y_train, x_val, y_val, conf):
	print("Model Maker Working...")
	if conf["type"] == "LSTM":
		model, m_perf = model_maker_LSTM(x_train, y_train, x_val, y_val, conf)
	elif conf["type"] == "GRU":
		model, m_perf = model_maker_GRU(x_train, y_train, x_val, y_val, conf)
	elif conf["type"] == "SimpleRNN":
		model, m_perf = model_maker_SimpleRNN(x_train, y_train, x_val, y_val, conf)
	elif conf["type"] == "MPL":
		model, m_perf = model_maker_MPL(x_train, y_train, x_val, y_val, conf)
	return model, m_perf
